...
try:
    ...
    # we can also inssert the first line into the file
    todo_file.write("title,completed\n")
    todo_file.close()
    print("In try except block")

print(f"{fg('black')}{bg('yellow')}Welcome to your TODO List{attr('reset')}")

def create_menu():
    print("1. Enter 1 to add item to your list")
    print("2. Enter 2 to remove item from your list")
    print("2. Enter 3 to mark an item as completed")
    print("2. Enter 4 to to view your todo list")
